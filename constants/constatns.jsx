...
export const jobsData = [
  {
    price: "$80,000 - $100,000/year",
    fullName: "John Doe",
    description:
      "John is a passionate developer with 5 years of experience in building scalable frontend applications using React.",
    location: "New York, NY",
  },
  {
    price: "$60,000 - $80,000/year",
    fullName: "Jane Smith",
    description:
      "Jane has extensive experience in backend development, focusing on cloud applications and scalable server-side technologies.",
    location: "San Francisco, CA",
  },
  {
    price: "$90,000 - $110,000/year",
    fullName: "Michael Johnson",
    description:
      "Michael is a seasoned full-stack developer, specializing in building end-to-end solutions with a focus on both frontend and backend systems.",
    location: "Austin, TX",
  },
  {
    price: "$50,000 - $70,000/year",
    fullName: "Emily Davis",
    description:
      "Emily is a creative UI/UX designer with a passion for crafting visually stunning and user-friendly designs.",
    location: "Los Angeles, CA",
  },
  {
    price: "$100,000 - $120,000/year",
    fullName: "David Lee",
    description:
      "David is an experienced DevOps engineer with expertise in cloud technologies and automation tools to optimize infrastructure.",
    location: "Seattle, WA",
  },
  {
    price: "$120,000 - $140,000/year",
    fullName: "Sarah Miller",
    description:
      "Sarah is a data science expert with a focus on predictive analytics and machine learning to derive business insights.",
    location: "Boston, MA",
  },
  {
    price: "$80,000 - $100,000/year",
    ...
    description:
      "Mark is a mobile app developer with a strong background in building high-performance iOS and Android applications.",
    location: "Chicago, IL",
  },
];
...
export function timeAgo(postTime) {
  const now = new Date();
  const secondsAgo = Math.floor((now.getTime() - postTime.getTime()) / 1000);
