import { useJobsCommunity } from "@/hooks/useJobsCommunity";
...
// Main Jobs Component
const Jobs = ({ communityId }) => {
  const [searchTitle, setSearchTitle] = useState("");
  const [searchLocation, setSearchLocation] = useState("");
  const { jobs } = useJobsCommunity(communityId);
  console.log(jobs);
  ...
  return (
    <div className="mb-4">
      ...
      />
      <div className="grid grid-cols-12  mx-auto gap-2 py-2">
        <div className="col-span-12 space-y-2 w-full md:w-auto px-3">
          {jobs.length > 0 ? (
