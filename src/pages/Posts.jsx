...
import { SearchBar, useJobFilter } from "@/components/jobs/Jobs";
    ...
    <>
      <div className="min-h-screen  xl:mx-0 relative bg-white">
        <div className="md:container mx-auto flex md:gap-4 flex-col md:flex-row">
          <div className="md:w-1/6 bg-white">
          ...
          <div className="md:w-5/6 mx-3">
            <h2 className="text-2xl font-bold cursive--font mb-3 mx-3">
              {communityData?.name}
            </h2>
            {selectedTab == "posts" && (
              <PostForm
            ...
            <main className="w-full   dark:bg-slate-950 dark:border rounded-lg overflow-y-auto  mb-4">
